  ...
  Future<void> _register(BuildContext context) async {
    ...
    if (name.isEmpty || email.isEmpty || password.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Por favor, complete todos los campos de usuario.'),
    ...
    if (!_allPetsValid()) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Por favor, complete todos los campos de la mascota.'),
        backgroundColor: Colors.red,
      ));
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('usuario').doc(userCredential.user?.uid).set({
        'nombre': name,
        'email': email,
